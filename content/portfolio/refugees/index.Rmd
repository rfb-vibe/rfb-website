...
ggsave(total_over_time_plot, filename = "outputs/total_over_time_plot.png",
       dpi = 300, type = "cairo",
       width = 4, height = 3, units = "in")

ggsave(total_over_time_plot, filename = "outputs/total_over_time_plot.pdf",
       device = cairo_pdf,
       width = 4, height = 3, units = "in")
...
ggsave(rankings_plot, filename = "outputs/rankings_plot.png",
       dpi = 300, type = "cairo",
       width = 4, height = 3, units = "in")

ggsave(rankings_plot, filename = "outputs/rankings_plot.pdf",
       device = cairo_pdf,
       width = 4, height = 3, units = "in")
