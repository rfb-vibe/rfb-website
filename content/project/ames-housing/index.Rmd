...
Using the [Ames, IA Housing dataset](https://www.kaggle.com/c/house-prices-advanced-regression-techniques), this lab practices using `pandas` to calculate central tendency, create subsets of data, use data visualizations to explore data, and gain insight into the dataset.
