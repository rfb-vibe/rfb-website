...
Using data from the 2018 Men's World Cup, this lab practices reading serialized JSON and CSV files into Python objects; extracting information from nested data structures; cleaning and merging data from multiple sources; and interpreting descriptive statistics and visualizations.
